    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        ...
        if(itemRegistryObject.get() instanceof ArmorItem armorItem) {
            trimMaterials.forEach((trimMaterial, value) -> {
                ...
                if (ArmorHelper.trimArmorAnyLeatherArmor(itemRegistryObject)) {
                ...
                } else if (ArmorHelper.trimArmorAnyTintedHelmet(itemRegistryObject)) {
                    getBuilder(currentTrimName)
                            .parent(new ModelFile.UncheckedModelFile("item/generated"))
                            .texture("layer1", armorItemResLoc)
                            .texture("layer0", tintedoverlayResLoc)
                            .texture("layer2", trimResLoc);
                } else if (ArmorHelper.trimArmorAnyWooledArmor(itemRegistryObject)) {
                    getBuilder(currentTrimName)
                            .parent(new ModelFile.UncheckedModelFile("item/generated"))
                            .texture("layer1", armorItemResLoc)
