...
import net.raylirov.coolarmor.content.armor.ModEffectArmorItem;
...
public class ModItems {
    ...
    public static final Item NETHERITE_TURTLE_HELMET = registerItem("netherite_turtle_helmet",
            new ModEffectArmorItem(ModArmorMaterials.NETHERITE_TURTLE, ArmorItem.Type.HELMET, new FabricItemSettings().fireproof()));
    public static final Item NETHERITE_TURTLE_CHESTPLATE = registerItem("netherite_turtle_chestplate",
            new ModEffectArmorItem(ModArmorMaterials.NETHERITE_TURTLE, ArmorItem.Type.CHESTPLATE, new FabricItemSettings().fireproof()));
    public static final Item NETHERITE_TURTLE_LEGGINGS = registerItem("netherite_turtle_leggings",
            new ModEffectArmorItem(ModArmorMaterials.NETHERITE_TURTLE, ArmorItem.Type.LEGGINGS, new FabricItemSettings().fireproof()));
    public static final Item NETHERITE_TURTLE_BOOTS = registerItem("netherite_turtle_boots",
            new ModEffectArmorItem(ModArmorMaterials.NETHERITE_TURTLE, ArmorItem.Type.BOOTS, new FabricItemSettings().fireproof()));
