...
<<<<<<< Updated upstream:src/main/java/net/raylirov/coolarmor/content/armor/ModArmorMaterials.java
...
public enum CAArmorMaterials implements ArmorMaterial {
    ...
    IRON_WOOLED("iron_wooled", 15, new int[]{ 3, 6, 5, 2 }, 9,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> Ingredient.ofItems(Items.IRON_INGOT));
>>>>>>> Stashed changes:src/main/java/net/raylirov/coolarmor/content/armor/CAArmorMaterials.java
...
=======
    CAArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound,
